...
Create Variables Create an additive score for internalising difficulties (emotional and peer problems) and externalising difficulties (conduct and hyperactivity problems).
...
# STANDARDISE WITHIN TIME POINT
# EXTERNALISING PROBLEMS
myData$BEXT_z <- scale(myData$BEXT, center = 0, scale = 1)
myData$CEXT_z <- scale(myData$CEXT, center = 0, scale = 1)
myData$DEXT_z <- scale(myData$DEXT, center = 0, scale = 1)
myData$FEXT_z <- scale(myData$FEXT, center = 0, scale = 1)

# INTERNALISING PROBLEMS
myData$BINT_z <- scale(myData$BINT, center = 0, scale = 1)
myData$CINT_z <- scale(myData$CINT, center = 0, scale = 1)
myData$DINT_z <- scale(myData$DINT, center = 0, scale = 1)
myData$FINT_z <- scale(myData$FINT, center = 0, scale = 1)

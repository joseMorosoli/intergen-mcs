---
title: "Calculate polygenic scores"
...
The current document describes how polygenic scores were calculated for this study:

1. Preliminary steps.
2. Using LDPred2 (pipeline).

The pipeline to compute polygenic scores with LDpred2 in MCS was modified on https://github.com/AndreAllegrini/LDpred2.


## Preliminary steps
### From dataset containing only trios, extract HapMap3 variants
...
cat('reading .bed...')
(rds <- snp_readBed2(bedfile = paste0(geno_path,'mcs_imputed_allchr_minQC_updateID_hetQC_relatedQC_trios-hapmap-only.bed'),
...
## Run pipeline
Note: Based on https://github.com/AndreAllegrini/LDpred2

```{r engine = 'bash', eval = FALSE}
# take first column of excel input file
sumstat=$(awk -F ',' 'NR==1 {print $1}' ${WORKdir}/sumstats_list.csv)

#take second column of excel input file
